    ...
    return (
        <div className='contenedor_transferencia' >
            ...
            <div className='transferencia'>
                <h2>TRANSFERENCIA</h2>
                <form className='formulario_transferencia' onSubmit={e => (datos_formulario(e))}>
                    ...
                    <div className='campo_identificacion_transferencia'>
                        <div className='cont_input2'>
                            <label htmlFor="numero_identificacion">N° de identificacion</label>
                            <input type="number" name='numero_identificacion' required />
                        </div>
                        <div className='cont_input3'>
                            <label htmlFor="tipo_documento">Tipo de documento</label>
                            <select name='tipo_documento'>
                            <option defaultValue="" disabled >Escoger tipo de documento</option>
                            <option defaultValue="cedula_ciudadania">Cedula de ciudadanía</option>
                            <option defaultValue="cedula_extranjera">Cedula Extranjera</option>
                            <option defaultValue="tarjeta_de_identidad">Tarjeta de identidad</option>
                            </select>
                        </div>
                    </div>
